...
public class Transaction {
    ...
    @NonNull private TransactionStatus status = TransactionStatus.PENDING;

    @Builder.Default
    @DynamoDBTypeConvertedEnum
    @DynamoDBAttribute(attributeName = TRANSACTION_DDB_ATTRIBUTE_ERROR_STATUS)
    private TransactionErrorType error = TransactionErrorType.NONE;
    ...
    private List<String> refundTransacIds = new ArrayList<>();
